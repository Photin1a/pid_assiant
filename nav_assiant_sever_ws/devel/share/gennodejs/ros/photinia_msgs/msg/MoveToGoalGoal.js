...
class MoveToGoalGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      this.motion_model = null;
      this.target_pose = null;
    }
    else {
      if (initObj.hasOwnProperty('motion_model')) {
        this.motion_model = initObj.motion_model
      }
      else {
        this.motion_model = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [motion_model]
    bufferOffset = _serializer.uint64(obj.motion_model, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [motion_model]
    data.motion_model = _deserializer.uint64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    if (msg.motion_model !== undefined) {
      resolved.motion_model = msg.motion_model;
    }
    else {
      resolved.motion_model = 0
    }
