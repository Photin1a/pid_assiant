...
class PIDParams_srvRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PIDParams_srvRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PIDParams_srvRequest
    let len;
    let data = new PIDParams_srvRequest(null);
  ...
  static datatype() {
    ...
    return 'photinia_msgs/PIDParams_srvRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PIDParams_srvRequest(null);
...
class PIDParams_srvResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PIDParams_srvResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PIDParams_srvResponse
    let len;
    let data = new PIDParams_srvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PIDParams_srvResponse(null);
...
module.exports = {
  Request: PIDParams_srvRequest,
  Response: PIDParams_srvResponse,
  md5sum() { return '5ad8bacb8dea16aa1298169b29166847'; },
  datatype() { return 'photinia_msgs/PIDParams_srv'; }
};
