...
class CarBaseMoveTaskActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new CarBaseMoveTaskGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CarBaseMoveTaskGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CarBaseMoveTaskActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = CarBaseMoveTaskGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CarBaseMoveTaskGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CarBaseMoveTaskActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CarBaseMoveTaskGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CarBaseMoveTaskGoal()
    }
...
module.exports = CarBaseMoveTaskActionGoal;
