...
class TakeAPictureActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new TakeAPictureFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = TakeAPictureFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TakeAPictureActionFeedback(null);
    ...
    data.feedback = TakeAPictureFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TakeAPictureActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = TakeAPictureFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new TakeAPictureFeedback()
    }
...
module.exports = TakeAPictureActionFeedback;
