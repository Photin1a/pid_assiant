...
class CurrentCorrectionPointActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CurrentCorrectionPointFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CurrentCorrectionPointFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CurrentCorrectionPointActionFeedback(null);
    ...
    data.feedback = CurrentCorrectionPointFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CurrentCorrectionPointActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CurrentCorrectionPointFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CurrentCorrectionPointFeedback()
    }
...
module.exports = CurrentCorrectionPointActionFeedback;
