...
class CarBaseMoveTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new CarBaseMoveTaskFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CarBaseMoveTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CarBaseMoveTaskActionFeedback(null);
    ...
    data.feedback = CarBaseMoveTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CarBaseMoveTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = CarBaseMoveTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new CarBaseMoveTaskFeedback()
    }
...
module.exports = CarBaseMoveTaskActionFeedback;
