...
class AcquisitionTaskActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new AcquisitionTaskFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AcquisitionTaskFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AcquisitionTaskActionFeedback(null);
    ...
    data.feedback = AcquisitionTaskFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += AcquisitionTaskFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AcquisitionTaskActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = AcquisitionTaskFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new AcquisitionTaskFeedback()
    }
...
module.exports = AcquisitionTaskActionFeedback;
