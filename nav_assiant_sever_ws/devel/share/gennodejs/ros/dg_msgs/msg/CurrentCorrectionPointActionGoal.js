...
class CurrentCorrectionPointActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new CurrentCorrectionPointGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = CurrentCorrectionPointGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new CurrentCorrectionPointActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = CurrentCorrectionPointGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += CurrentCorrectionPointGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CurrentCorrectionPointActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = CurrentCorrectionPointGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new CurrentCorrectionPointGoal()
    }
...
module.exports = CurrentCorrectionPointActionGoal;
