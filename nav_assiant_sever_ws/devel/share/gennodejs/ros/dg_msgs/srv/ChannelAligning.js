...
class ChannelAligningRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChannelAligningRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChannelAligningRequest
    let len;
    let data = new ChannelAligningRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChannelAligningRequest(null);
...
class ChannelAligningResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChannelAligningResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChannelAligningResponse
    let len;
    let data = new ChannelAligningResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChannelAligningResponse(null);
...
module.exports = {
  Request: ChannelAligningRequest,
  Response: ChannelAligningResponse,
  md5sum() { return '7a688dfc87e588c1b04a6359014918f4'; },
  datatype() { return 'dg_msgs/ChannelAligning'; }
};
