...
class TunnelModelRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TunnelModelRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TunnelModelRequest
    let len;
    let data = new TunnelModelRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new TunnelModelRequest(null);
...
class TunnelModelResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type TunnelModelResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type TunnelModelResponse
    let len;
    let data = new TunnelModelResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dg_msgs/TunnelModelResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TunnelModelResponse(null);
...
module.exports = {
  Request: TunnelModelRequest,
  Response: TunnelModelResponse,
  md5sum() { return '8ba35436416732eff731a783354a9a3d'; },
  datatype() { return 'dg_msgs/TunnelModel'; }
};
