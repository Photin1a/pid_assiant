...
class RobotArmRestRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RobotArmRestRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RobotArmRestRequest
    let len;
    let data = new RobotArmRestRequest(null);
  ...
  static datatype() {
    ...
    return 'dg_msgs/RobotArmRestRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotArmRestRequest(null);
...
class RobotArmRestResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RobotArmRestResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RobotArmRestResponse
    let len;
    let data = new RobotArmRestResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dg_msgs/RobotArmRestResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotArmRestResponse(null);
...
module.exports = {
  Request: RobotArmRestRequest,
  Response: RobotArmRestResponse,
  md5sum() { return '30dd77b2b7250d51d2b5b47933ff7787'; },
  datatype() { return 'dg_msgs/RobotArmRest'; }
};
