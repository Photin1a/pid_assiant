...
class RobotArmStandbyRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RobotArmStandbyRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RobotArmStandbyRequest
    let len;
    let data = new RobotArmStandbyRequest(null);
  ...
  static datatype() {
    ...
    return 'dg_msgs/RobotArmStandbyRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotArmStandbyRequest(null);
...
class RobotArmStandbyResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type RobotArmStandbyResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type RobotArmStandbyResponse
    let len;
    let data = new RobotArmStandbyResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotArmStandbyResponse(null);
...
module.exports = {
  Request: RobotArmStandbyRequest,
  Response: RobotArmStandbyResponse,
  md5sum() { return '30dd77b2b7250d51d2b5b47933ff7787'; },
  datatype() { return 'dg_msgs/RobotArmStandby'; }
};
