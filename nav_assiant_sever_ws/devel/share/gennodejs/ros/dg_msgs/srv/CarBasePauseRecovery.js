...
class CarBasePauseRecoveryRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CarBasePauseRecoveryRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CarBasePauseRecoveryRequest
    let len;
    let data = new CarBasePauseRecoveryRequest(null);
  ...
  static datatype() {
    ...
    return 'dg_msgs/CarBasePauseRecoveryRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CarBasePauseRecoveryRequest(null);
...
class CarBasePauseRecoveryResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type CarBasePauseRecoveryResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type CarBasePauseRecoveryResponse
    let len;
    let data = new CarBasePauseRecoveryResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'dg_msgs/CarBasePauseRecoveryResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new CarBasePauseRecoveryResponse(null);
...
module.exports = {
  Request: CarBasePauseRecoveryRequest,
  Response: CarBasePauseRecoveryResponse,
  md5sum() { return '3ad2694b73fbad8069428f9f9462a738'; },
  datatype() { return 'dg_msgs/CarBasePauseRecovery'; }
};
