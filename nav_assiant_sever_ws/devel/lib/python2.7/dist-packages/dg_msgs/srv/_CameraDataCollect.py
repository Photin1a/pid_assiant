...
"""autogenerated by genpy from dg_msgs/CameraDataCollectRequest.msg. Do not edit."""
import codecs
import sys
...
class CameraDataCollectRequest(genpy.Message):
  _md5sum = "64334ff0caad3c60c3dbf62c3620ae4c"
  _type = "dg_msgs/CameraDataCollectRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string point_cloud_path
"""
  __slots__ = ['point_cloud_path']
  _slot_types = ['string']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CameraDataCollectRequest, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.point_cloud_path = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.point_cloud_path = str[start:end]
      return self
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dg_msgs/CameraDataCollectResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class CameraDataCollectResponse(genpy.Message):
  _md5sum = "62cbe1cfe333a66132a02f178e9a8274"
  _type = "dg_msgs/CameraDataCollectResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CameraDataCollectResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_IBI():
    ...
    return _struct_IBI
class CameraDataCollect(object):
  _type          = 'dg_msgs/CameraDataCollect'
  _md5sum = 'c67c27276579d6590e6569ff105e6071'
  _request_class  = CameraDataCollectRequest
  _response_class = CameraDataCollectResponse
