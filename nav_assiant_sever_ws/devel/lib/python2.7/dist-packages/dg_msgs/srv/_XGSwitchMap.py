...
"""autogenerated by genpy from dg_msgs/XGSwitchMapRequest.msg. Do not edit."""
import codecs
import sys
...
class XGSwitchMapRequest(genpy.Message):
  _md5sum = "e04283d464b11a3c09dbb49d716a6b55"
  _type = "dg_msgs/XGSwitchMapRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string map_name
bool allow_move                     # 当切换地图的时候是否允许移动到地图切换点【严禁缺省】因为涉及到底盘运动和电梯待命等信息
"""
  __slots__ = ['map_name','allow_move']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(XGSwitchMapRequest, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.map_name is None:
        self.map_name = ''
      if self.allow_move is None:
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.allow_move,) = _get_struct_B().unpack(str[start:end])
      self.allow_move = bool(self.allow_move)
      return self
...
def _get_struct_B():
    ...
    return _struct_B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from dg_msgs/XGSwitchMapResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class XGSwitchMapResponse(genpy.Message):
  _md5sum = "8b810613bd7e6867ccbfac2fb14e2de4"
  _type = "dg_msgs/XGSwitchMapResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
string state_msgs   # 附加信息，相当于additional_msgs"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(XGSwitchMapResponse, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
...
def _get_struct_i():
    ...
    return _struct_i
class XGSwitchMap(object):
  _type          = 'dg_msgs/XGSwitchMap'
  _md5sum = '65916606f07351a8c2635db69ef80d88'
  _request_class  = XGSwitchMapRequest
  _response_class = XGSwitchMapResponse
