...
"""autogenerated by genpy from dg_msgs/PointSequence.msg. Do not edit."""
import codecs
import sys
...
class PointSequence(genpy.Message):
  _md5sum = "b0d9a719acd34e16fa2945a901af80a3"
  _type = "dg_msgs/PointSequence"
...
"""
  __slots__ = ['number','points']
  _slot_types = ['string','dg_msgs/ImagePoint[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(PointSequence, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.custom_message = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.custom_message = str[start:end]
        _v18 = val1.image_goal
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
        ...
        if python3:
          val1.point_file_name = str[start:end].decode('utf-8', 'rosmsg')
        else:
          val1.point_file_name = str[start:end]
