...
"""autogenerated by genpy from dg_msgs/AcquisitionTaskActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class AcquisitionTaskActionFeedback(genpy.Message):
  _md5sum = "15b9a36c99af28bebb63e64ab41314de"
  _type = "dg_msgs/AcquisitionTaskActionFeedback"
...
float32[] intrinsic # 相机内参"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dg_msgs/AcquisitionTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AcquisitionTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dg_msgs.msg.AcquisitionTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dg_msgs.msg.AcquisitionTaskFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.feedback.results)
      buff.write(_struct_I.pack(length))
      for val1 in self.feedback.results:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.feedback.results.append(val1)
      return self
