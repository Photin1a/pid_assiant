...
"""autogenerated by genpy from dg_msgs/HardwareAndNodeState.msg. Do not edit."""
import codecs
import sys
...
class HardwareAndNodeState(genpy.Message):
  _md5sum = "563ccdb7932eed0e6e8e7fd05942ee29"
  _type = "dg_msgs/HardwareAndNodeState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """dg_msgs/ROSTopicState[] ros_topic_state                 # ros话题状态
...
string state_msgs   # 附加信息，相当于additional_msgs"""
  __slots__ = ['ros_topic_state','ros_node_state','ros_service_state','daemon_state','system_file_state','networked_device_state','cpu_mem_state','chassis_state','working_node_error','last_update_time']
  _slot_types = ['dg_msgs/ROSTopicState[]','dg_msgs/GeneralHardwareAndNodeState[]','dg_msgs/GeneralHardwareAndNodeState[]','dg_msgs/GeneralHardwareAndNodeState[]','dg_msgs/GeneralHardwareAndNodeState[]','dg_msgs/NetworkedDevicesState[]','dg_msgs/CPUMemNetState','dg_msgs/ChassisState','dg_msgs/UniversalStateInfo[]','string']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       ros_topic_state,ros_node_state,ros_service_state,daemon_state,system_file_state,networked_device_state,cpu_mem_state,chassis_state,working_node_error,last_update_time
    ...
    """
    if args or kwds:
      super(HardwareAndNodeState, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.ros_topic_state is None:
        self.ros_topic_state = []
      if self.ros_node_state is None:
        self.ros_node_state = []
      if self.ros_service_state is None:
        self.ros_service_state = []
      if self.daemon_state is None:
        self.daemon_state = []
      if self.system_file_state is None:
        self.system_file_state = []
      if self.networked_device_state is None:
        self.networked_device_state = []
      if self.cpu_mem_state is None:
        self.cpu_mem_state = dg_msgs.msg.CPUMemNetState()
      if self.chassis_state is None:
        self.chassis_state = dg_msgs.msg.ChassisState()
      if self.working_node_error is None:
        self.working_node_error = []
  ...
  def serialize(self, buff):
    ...
    """
    try:
      length = len(self.ros_topic_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.ros_topic_state:
        _x = val1.topic_name
        length = len(_x)
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.ros_node_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.ros_node_state:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.ros_service_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.ros_service_state:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.daemon_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.daemon_state:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.system_file_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.system_file_state:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.networked_device_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.networked_device_state:
        _x = val1.device_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_id4i3f().pack(_x.cpu_mem_state.cpu_count, _x.cpu_mem_state.cpu_usage, _x.cpu_mem_state.cpu_load_1min, _x.cpu_mem_state.cpu_load_5min, _x.cpu_mem_state.cpu_load_15min, _x.cpu_mem_state.process_count, _x.cpu_mem_state.mem_total, _x.cpu_mem_state.mem_free, _x.cpu_mem_state.mem_used_percent))
      length = len(self.cpu_mem_state.disk_states)
      buff.write(_struct_I.pack(length))
      for val1 in self.cpu_mem_state.disk_states:
        _x = val1.disk_name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.cpu_mem_state.network_card_state)
      buff.write(_struct_I.pack(length))
      for val1 in self.cpu_mem_state.network_card_state:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.chassis_state.chassis_state_json
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.chassis_state.chassis_type
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.chassis_state.chassis_name
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_f3I().pack(_x.chassis_state.battery, _x.chassis_state.current_pose.header.seq, _x.chassis_state.current_pose.header.stamp.secs, _x.chassis_state.current_pose.header.stamp.nsecs))
      _x = self.chassis_state.current_pose.header.frame_id
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_7dB3I().pack(_x.chassis_state.current_pose.pose.position.x, _x.chassis_state.current_pose.pose.position.y, _x.chassis_state.current_pose.pose.position.z, _x.chassis_state.current_pose.pose.orientation.x, _x.chassis_state.current_pose.pose.orientation.y, _x.chassis_state.current_pose.pose.orientation.z, _x.chassis_state.current_pose.pose.orientation.w, _x.chassis_state.is_charged, _x.chassis_state.header.seq, _x.chassis_state.header.stamp.secs, _x.chassis_state.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.chassis_state.state_info.error_code
      buff.write(_get_struct_i().pack(_x))
      _x = self.chassis_state.state_info.additional_msgs
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.working_node_error)
      buff.write(_struct_I.pack(length))
      for val1 in self.working_node_error:
        _x = val1.state_index
        buff.write(_get_struct_i().pack(_x))
        _x = val1.node_name
        length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      if self.ros_topic_state is None:
        self.ros_topic_state = None
      if self.ros_node_state is None:
        self.ros_node_state = None
      if self.ros_service_state is None:
        self.ros_service_state = None
      if self.daemon_state is None:
        self.daemon_state = None
      if self.system_file_state is None:
        self.system_file_state = None
      if self.networked_device_state is None:
        self.networked_device_state = None
      if self.cpu_mem_state is None:
        self.cpu_mem_state = dg_msgs.msg.CPUMemNetState()
      if self.chassis_state is None:
        self.chassis_state = dg_msgs.msg.ChassisState()
      if self.working_node_error is None:
        self.working_node_error = None
      end = 0
      start = end
      end += 4
      ...
      for i in range(0, length):
        ...
        self.ros_topic_state.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ros_node_state = []
      for i in range(0, length):
        ...
        self.ros_node_state.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.ros_service_state = []
      for i in range(0, length):
        ...
        self.ros_service_state.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.daemon_state = []
      ...
      for i in range(0, length):
        ...
        self.system_file_state.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.networked_device_state = []
      for i in range(0, length):
        ...
        self.networked_device_state.append(val1)
      _x = self
      start = end
      end += 40
      (_x.cpu_mem_state.cpu_count, _x.cpu_mem_state.cpu_usage, _x.cpu_mem_state.cpu_load_1min, _x.cpu_mem_state.cpu_load_5min, _x.cpu_mem_state.cpu_load_15min, _x.cpu_mem_state.process_count, _x.cpu_mem_state.mem_total, _x.cpu_mem_state.mem_free, _x.cpu_mem_state.mem_used_percent,) = _get_struct_id4i3f().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.cpu_mem_state.disk_states = []
      for i in range(0, length):
        ...
        self.cpu_mem_state.disk_states.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.cpu_mem_state.network_card_state = []
      for i in range(0, length):
        ...
        self.cpu_mem_state.network_card_state.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.chassis_state.chassis_state_json = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.chassis_state.chassis_state_json = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.chassis_state.chassis_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.chassis_state.chassis_type = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.chassis_state.chassis_name = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.chassis_state.chassis_name = str[start:end]
      _x = self
      start = end
      end += 16
      (_x.chassis_state.battery, _x.chassis_state.current_pose.header.seq, _x.chassis_state.current_pose.header.stamp.secs, _x.chassis_state.current_pose.header.stamp.nsecs,) = _get_struct_f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.chassis_state.current_pose.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.chassis_state.current_pose.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 69
      (_x.chassis_state.current_pose.pose.position.x, _x.chassis_state.current_pose.pose.position.y, _x.chassis_state.current_pose.pose.position.z, _x.chassis_state.current_pose.pose.orientation.x, _x.chassis_state.current_pose.pose.orientation.y, _x.chassis_state.current_pose.pose.orientation.z, _x.chassis_state.current_pose.pose.orientation.w, _x.chassis_state.is_charged, _x.chassis_state.header.seq, _x.chassis_state.header.stamp.secs, _x.chassis_state.header.stamp.nsecs,) = _get_struct_7dB3I().unpack(str[start:end])
      self.chassis_state.is_charged = bool(self.chassis_state.is_charged)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.chassis_state.state_info.error_code,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.chassis_state.state_info.additional_msgs = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.chassis_state.state_info.additional_msgs = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.working_node_error = []
      for i in range(0, length):
        ...
        self.working_node_error.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.last_update_time = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.last_update_time = str[start:end]
      return self
