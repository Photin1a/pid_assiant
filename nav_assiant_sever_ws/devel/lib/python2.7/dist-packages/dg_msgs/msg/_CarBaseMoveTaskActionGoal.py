...
"""autogenerated by genpy from dg_msgs/CarBaseMoveTaskActionGoal.msg. Do not edit."""
import codecs
import sys
...
class CarBaseMoveTaskActionGoal(genpy.Message):
  _md5sum = "691ce842de0edaf146724317d9ef0d4c"
  _type = "dg_msgs/CarBaseMoveTaskActionGoal"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalID','dg_msgs/CarBaseMoveTaskGoal']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CarBaseMoveTaskActionGoal, self).__init__(*args, **kwds)
      ...
      if self.goal is None:
        self.goal = dg_msgs.msg.CarBaseMoveTaskGoal()
    else:
      self.header = std_msgs.msg.Header()
      self.goal_id = actionlib_msgs.msg.GoalID()
      self.goal = dg_msgs.msg.CarBaseMoveTaskGoal()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.goal.target_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.goal.target_type = str[start:end]
      return self
