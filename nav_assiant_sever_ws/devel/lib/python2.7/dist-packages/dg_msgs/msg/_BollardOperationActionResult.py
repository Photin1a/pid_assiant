...
"""autogenerated by genpy from dg_msgs/BollardOperationActionResult.msg. Do not edit."""
import codecs
import sys
...
class BollardOperationActionResult(genpy.Message):
  _md5sum = "647f54904079c9c25b8d71a5d11df6d7"
  _type = "dg_msgs/BollardOperationActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dg_msgs/BollardOperationResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BollardOperationActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dg_msgs.msg.BollardOperationResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dg_msgs.msg.BollardOperationResult()
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.arrived_height,) = _get_struct_f().unpack(str[start:end])
      return self
