...
"""autogenerated by genpy from dg_msgs/BollardOperationActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class BollardOperationActionFeedback(genpy.Message):
  _md5sum = "898350ad63faa5a5c5966810262be09a"
  _type = "dg_msgs/BollardOperationActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dg_msgs/BollardOperationFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(BollardOperationActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dg_msgs.msg.BollardOperationFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dg_msgs.msg.BollardOperationFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.current_height
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.current_height,) = _get_struct_f().unpack(str[start:end])
      return self
