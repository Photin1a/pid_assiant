...
"""autogenerated by genpy from dg_msgs/AcquisitionTaskActionResult.msg. Do not edit."""
import codecs
import sys
...
class AcquisitionTaskActionResult(genpy.Message):
  _md5sum = "c45869066c89936ff411656817153175"
  _type = "dg_msgs/AcquisitionTaskActionResult"
...
float32[] intrinsic # 相机内参"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dg_msgs/AcquisitionTaskResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AcquisitionTaskActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = dg_msgs.msg.AcquisitionTaskResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = dg_msgs.msg.AcquisitionTaskResult()
