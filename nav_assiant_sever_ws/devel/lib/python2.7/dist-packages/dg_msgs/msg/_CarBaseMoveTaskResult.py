...
"""autogenerated by genpy from dg_msgs/CarBaseMoveTaskResult.msg. Do not edit."""
import codecs
import sys
...
class CarBaseMoveTaskResult(genpy.Message):
  _md5sum = "fb056551c70c0a36ef2b4a2179be1f62"
  _type = "dg_msgs/CarBaseMoveTaskResult"
...
string state_msgs   # 附加信息，相当于additional_msgs"""
  __slots__ = ['time_cost','state_info']
  _slot_types = ['float32','dg_msgs/UniversalStateInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CarBaseMoveTaskResult, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_fi().pack(_x.time_cost, _x.state_info.state_index))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.time_cost, _x.state_info.state_index,) = _get_struct_fi().unpack(str[start:end])
      start = end
      end += 4
