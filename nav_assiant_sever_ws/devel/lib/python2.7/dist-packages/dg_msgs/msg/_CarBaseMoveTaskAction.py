...
"""autogenerated by genpy from dg_msgs/CarBaseMoveTaskAction.msg. Do not edit."""
import codecs
import sys
...
class CarBaseMoveTaskAction(genpy.Message):
  _md5sum = "e9bb1d4b838f5d8738e44d540b94d7a3"
  _type = "dg_msgs/CarBaseMoveTaskAction"
...
"""
  ...
  _slot_types = ['dg_msgs/CarBaseMoveTaskActionGoal','dg_msgs/CarBaseMoveTaskActionResult','dg_msgs/CarBaseMoveTaskActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CarBaseMoveTaskAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = dg_msgs.msg.CarBaseMoveTaskActionGoal()
      if self.action_result is None:
        self.action_result = dg_msgs.msg.CarBaseMoveTaskActionResult()
      if self.action_feedback is None:
        self.action_feedback = dg_msgs.msg.CarBaseMoveTaskActionFeedback()
    else:
      self.action_goal = dg_msgs.msg.CarBaseMoveTaskActionGoal()
      self.action_result = dg_msgs.msg.CarBaseMoveTaskActionResult()
      self.action_feedback = dg_msgs.msg.CarBaseMoveTaskActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_fi().pack(_x.action_result.result.time_cost, _x.action_result.result.state_info.state_index))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.action_feedback.feedback.remaining_dis
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.target_type = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_goal.goal.target_type = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (_x.action_result.result.time_cost, _x.action_result.result.state_info.state_index,) = _get_struct_fi().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.remaining_dis,) = _get_struct_f().unpack(str[start:end])
      return self
