...
"""autogenerated by genpy from dg_msgs/TakeAPictureActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class TakeAPictureActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "dg_msgs/TakeAPictureActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dg_msgs/TakeAPictureFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TakeAPictureActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dg_msgs.msg.TakeAPictureFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dg_msgs.msg.TakeAPictureFeedback()
