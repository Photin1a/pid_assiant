...
"""autogenerated by genpy from dg_msgs/CarBaseMoveTaskActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class CarBaseMoveTaskActionFeedback(genpy.Message):
  _md5sum = "d7b44b66e964c0011dec9c8f17cf5c58"
  _type = "dg_msgs/CarBaseMoveTaskActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','dg_msgs/CarBaseMoveTaskFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CarBaseMoveTaskActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = dg_msgs.msg.CarBaseMoveTaskFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = dg_msgs.msg.CarBaseMoveTaskFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.remaining_dis
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.remaining_dis,) = _get_struct_f().unpack(str[start:end])
      return self
