...
"""autogenerated by genpy from photinia_msgs/MoveToGoalGoal.msg. Do not edit."""
import codecs
import sys
...
class MoveToGoalGoal(genpy.Message):
  _md5sum = "55f0730daa98852d32e373f328cb820c"
  _type = "photinia_msgs/MoveToGoalGoal"
...
float64 w
"""
  __slots__ = ['motion_model','target_pose']
  _slot_types = ['uint64','geometry_msgs/PoseStamped']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_Q3I().pack(_x.motion_model, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.motion_model, _x.target_pose.header.seq, _x.target_pose.header.stamp.secs, _x.target_pose.header.stamp.nsecs,) = _get_struct_Q3I().unpack(str[start:end])
      start = end
      end += 4
